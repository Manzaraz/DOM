...
export default function userDeviceInfo(id) {
    ...
    // contenido exclusivo:
    if (isBrowser.safari()) {
        $id.innerHTML += `<p><mark>Éste contenido sólo se ve en Safari</mark><p>`
    }
    if (isBrowser.chrome()) {
        $id.innerHTML += `<p><mark>Éste contenido sólo se ve en Chrome</mark><p>`
    }
    if (isBrowser.firefox()) {
        $id.innerHTML += `<p><mark>Éste contenido sólo se ve en Firefox </mark><p>`
    }
    if (isDesktop.linux()) {
